...
<main>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero__caption hero__caption2">
                                <h1 data-animation="bounceIn" data-delay="0.2s">Contáctenos</h1>
                                <!-- breadcrumb Start-->
    ...
    <section class="contact-section">
        <div class="container">
            <div id="mapid" style="height: 480px; position: sticky; overflow: hidden;"></div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="name" id="name" type="text"
                                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nombre Completo'"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="email" id="email" type="email"
                                        ...
                                        onblur="this.placeholder = 'Correo electrónico'" placeholder="Correo electrónico">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>Panamericana, Nueva San Salvador, La Libertad.</h3>
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>+503 2132-7400 / 7551</h3>
                            <p>Lunes a Sábado de 8:00 am - 5:00 pm </p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-email"></i></span>
                        <div class="media-body">
                            <h3>coursescloudmind@gmail.com</h3>
                            <p>No dudes en realizar tus consultas.</p>
                        </div>
                    </div>
                </div>
            </div>
