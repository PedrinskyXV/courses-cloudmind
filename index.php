                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-services mb-30">
                        ...
                        <div class="features-caption">
                            ...
                            <p>Experiencia en empresas de tecnología líder en mercado del software</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-8">
            ...
            <div class="courses-actives">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        ...
                        <div class="properties__caption">
                            <p>Base de datos</p>
                            <h3><a href="#">Diseño de base de datos</a></h3>
                            </p>
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <div class="rating">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        ...
                        <div class="properties__caption">
                            <p>Servidores</p>
                            <h3><a href="#">Configuración de servidores</a></h3>
                            </p>
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <div class="rating">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        ...
                        <div class="properties__caption">
                            <p>Sistemas</p>
                            <h3><a href="#">Administración de sistemas</a></h3>
                            </p>
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <div class="rating">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        ...
                        <div class="properties__caption">
                            <p>Diseño</p>
                            <h3><a href="#">Diseño Web Responsivo</a></h3>
                            </p>
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <div class="rating">
            ...
            <div class="left-content1">
                ...
                <div class="section-tittle section-tittle2 mb-55">
                    <div class="front-text">
                        <h2 class="">Aprende nuevas habilidades en línea con los mejores educadores</h2>
                        <p>Nuestros educadores han trabajado por muchos años en empresas de tecnología con bastante
                ...
                <div class="single-features">
                    ...
                    <div class="features-caption">
                        <p>Todo el contenido imparto es revisado por expertos en el area de enseñanza</p>
                    </div>
                </div>
                <div class="single-features">
                    <div class="features-icon">
                    ...
                    <div class="features-caption">
                        <p>Únete a millones de personas de todo el mundo aprendiendo juntas.</p>
                    </div>
                </div>
                ...
                <div class="single-features">
                    ...
                    <div class="features-caption">
                        <p>El aprendizaje en línea es igual de fácil y natural que ir a una universidad.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="team-active">
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.html">Pedro Pérez</a></h5>
                ...
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.html">Guillermo Hernández</a></h5>
                        <p>Ingeniero en Desarrollo de Software.</p>
                    </div>
                </div>
            </div>
